...
<body>
    <h1>Hello john, finish the development of the site, here's your <a href="id_rsa">RSA private key.</a></h1>
    <br><br>
...
1) Then I go in this directory "/admin/panel/id_rsa/":
```
...
1) Web flag: THM{brut3_f0rce_is_e4sy}